/*Create a function named Calculate that takes 2 parameters , adds them together,
and returns the answer to the main program. Name the parameters 'num1' and 'num2'. 
Create a variable in the main program named 'summedNumbers'.
In the main program, get two numbers from the user, 
then call the function, sending it the two numbers.  
So the two numbers must be passed into the function when you call it from the main program.
Name the variables in the main program different names than the function Calculate parameter names.
